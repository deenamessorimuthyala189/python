# graph = a graph data structure is the collection of the node that heve data and connected to other nodes
# eg: insta,fb
# every relationship is the edge from one node to another ,whether u post a photo  join a group or liking a page etc... or new connection is created for relationship
# path,directed graph
# types: null,none directed,directed,connected graph,disconnected ,regular,complete ,cyclic,acyclic,cycle ,finite,infinete,simple,multi,sudocode
# wapp to create a simple gragh
class SimpleGraph:
    def __init__(self):
        self.nodes = {}
        self.edges = set()
